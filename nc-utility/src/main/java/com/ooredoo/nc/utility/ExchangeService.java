...
public class ExchangeService implements ApplicationConstants, Serializable {
	...
	public Object exchangeData(String serviceInstance, HttpEntity<?> responseEntity, Object requestObject, HttpMethod httpMethod
		...
		try {
			LOGGER.info("exchangeData requestParams : {}",requestParams);
			...
			LOGGER.info("exchangeData responseBody : {}",responseBody);
			...
			if(null !=  e.getResponseBodyAsString() &&  !e.getResponseBodyAsString().isEmpty()) {
				...
				throw new ApplicationRestException(e.getRawStatusCode(), ((null != errorMessage && !errorMessage.isEmpty()) ? errorMessage : "500"));
