...
public class NcErpService implements ApplicationConstants {
	
	public static ConfigurableApplicationContext context = null;
	private static final Logger LOGGER = LoggerFactory.getLogger(NcErpService.class);
	...
	public static void main(String[] args) {
		try {
			...
			LOGGER.error("Error occurred while starting-up erp-cleanup-service. Cause-", e);
	...
	private static void initApplicationFramework(String[] args) throws ApplicationException {
		try {
			context = SpringApplication.run(NcErpService.class, args);
			context.registerShutdownHook();
			ApplicationContextHolder.getInstance().setApplicationContext(ERP, context);
